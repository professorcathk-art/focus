  ...
  return (
    <main style={{ padding: '40px 0', minHeight: '80vh' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
        <Link href="/" style={{ display: 'inline-block', marginBottom: '40px', color: 'var(--primary-light)' }}>
          ← Back to Home
        </Link>
        
        <h1 style={{ fontSize: '48px', fontWeight: 700, marginBottom: '24px', color: 'var(--primary-light)' }}>Privacy Policy</h1>
        <p style={{ color: 'var(--text-muted)', marginBottom: '40px' }}>
          Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
        </p>

        <div style={{ fontSize: '16px', lineHeight: '1.8', color: 'var(--text-light)' }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <ul style={{ marginLeft: '24px', marginBottom: '16px' }}>
              <li style={{ marginBottom: '8px' }}><strong>Supabase:</strong> Authentication, database, and storage services. See <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer">Supabase&apos;s privacy policy</a></li>
              <li style={{ marginBottom: '8px' }}><strong>Deepgram:</strong> Voice transcription services. See <a href="https://deepgram.com/privacy" target="_blank" rel="noopener noreferrer">Deepgram&apos;s privacy policy</a></li>
              <li style={{ marginBottom: '8px' }}><strong>AIMLAPI:</strong> AI services for embeddings and categorization.</li>
