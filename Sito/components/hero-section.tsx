        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="hero-content text-center lg:text-left max-w-2xl mx-auto lg:mx-0 order-2 lg:order-1">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-custom-text mb-4 sm:mb-6 leading-tight animate-fade-in-up tracking-tight">
              Connect with Global
              <span className="block text-cyber-green text-glow animate-neon-flicker mt-2">
                Industry Experts
              </span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-custom-text/90 mb-6 sm:mb-8 lg:mb-10 leading-relaxed animate-fade-in-up px-2 sm:px-0" style={{ animationDelay: '0.2s' }}>
