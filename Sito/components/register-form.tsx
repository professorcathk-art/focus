  ...
  return (
    <form onSubmit={handleSubmit} className="bg-dark-green-800/30 backdrop-blur-sm border border-cyber-green/30 p-8 rounded-2xl shadow-lg">
      ...
      <button
        ...
        className="w-full mt-4 flex items-center justify-center gap-3 bg-white text-dark-green-950 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-md"
      >
